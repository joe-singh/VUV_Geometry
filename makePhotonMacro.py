...
fname = '/data/snoplus/home/joesingh/VUV/VUV_Geometry/macros/'+filepath+'/photon_'+str(sample_angle)+'.'+str(angle)+'.mac'
f = open(fname, 'w')
...
f.write('/rat/db/set OPTICS[tpb] WLSMEANNUMBERVISPHOTONS 0.8\n')
